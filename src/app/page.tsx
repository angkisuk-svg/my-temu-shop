  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-slate-900 pb-20 font-sans text-slate-100">
      ...
      <section className="bg-slate-800 p-5 mb-4 shadow-xl border-b border-slate-700">
        <div className="bg-orange-500/20 text-orange-400 text-xs font-bold px-4 py-1 inline-block rounded mb-3 border border-orange-500/30">
          이포스팅은 쿠팡파트너스의 활동 일환으로 수수료를 받습니다.
        </div>
