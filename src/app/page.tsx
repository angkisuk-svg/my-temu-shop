  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-slate-900 pb-20 font-sans text-slate-100">
      ...
      <section className="bg-slate-800 p-5 mb-4 shadow-xl border-b border-slate-700">
        <div className="bg-orange-500/20 text-white-400 text-base font-bold px-2 py-1 inline-block rounded mb-3 border border-orange-500/30">
         이 포스팅은 쿠팡파트너스 활동의 일환으로  수수료를 받습니다.   [똑수기픽]
        </div>
